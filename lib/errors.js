module.exports = class ModuleTraverseError extends Error {
  ...
  static ADDON_NOT_FOUND (msg) {
    return new ModuleTraverseError(msg, 'ADDON_NOT_FOUND', ModuleTraverseError.ADDON_NOT_FOUND)
  }

  static ASSET_NOT_FOUND (msg) {
    return new ModuleTraverseError(msg, 'ASSET_NOT_FOUND', ModuleTraverseError.ASSET_NOT_FOUND)
  }
}
